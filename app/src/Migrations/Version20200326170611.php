...
final class Version20200326170611 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT NOT NULL, tree_root INT DEFAULT NULL, parent_id INT DEFAULT NULL, email VARCHAR(75) NOT NULL, img VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, telephone VARCHAR(15) DEFAULT NULL, roles JSONB NOT NULL, password VARCHAR(255) NOT NULL, lft INT NOT NULL, lvl INT NOT NULL, rgt INT NOT NULL, status VARCHAR(10) CHECK (status IN (\'active\', \'invited\')) NOT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
