...
final class Version20200601143104 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE chat (id INT NOT NULL, uuid uuid NOT NULL, owner_id INT NOT NULL, user_id INT, strategy VARCHAR(32) NOT NULL, unread_messages_count smallint,  unread_messages_sender_id INT NOT NULL, created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
